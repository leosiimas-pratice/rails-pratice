...
User.create name: 'Leonardo', status: :active, kind: :salesman, email: 'salesman2@teste.com', password: '123456'
...
Discount.create name: 'Desconto carnaval', description: 'Aplique esse descnto no carnaval', value: '10', kind: :porcent, status: :active
Discount.create name: 'Desconto carnaval dinheiro', description: 'Aplique esse descnto no carnaval', value: '10', kind: :money, status: :active
